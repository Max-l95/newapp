                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="text-center mt-sm-5 mb-4 text-white-50">
                                ...
                                <p className="mt-3 fs-15 fw-semibold">DgnsDesk</p>
                            </div>
                        </Col>
                    </Row>
                            ...
                            <Card className="mt-4">
                                <CardBody className="p-4">
                                    <div className="text-center mt-2">
                                        <h5 className="text-primary">Hai dimenticato la password?</h5>
                                        <p className="text-muted">Ripristina la tua Password</p>
                                    ...
                                    <Alert className="border-0 alert-warning text-center mb-2 mx-2" role="alert">
                                        Inserisci la mail e segui le istruzioni che ti saranno inviate!
                                    </Alert>
                                    <div className="p-2">
                                        <Form onSubmit={validation.handleSubmit}>
                                            ...
                                            <div className="text-center mt-4">
                                                <button className="btn btn-success w-100" type="submit">Invia Link di rispristino</button>
                                            </div>
                                        </Form>
                                    </div>
                                </CardBody>
