...
import { Row, Col, Modal, ModalHeader, ModalBody, ModalFooter, Input, Label, UncontrolledTooltip } from 'reactstrap';
import { APIClient } from '../../helpers/api_helper';

const NewCliente = ({ modalList, toggleList, fetchData }) => {
    ...
    const handleAddCliente = async (event) => {
        ...
        try {
            const response = await apiClient.create('/clienti/add', {
  ...
  return (
    <Modal size='xl' isOpen={modalList} toggle={toggleList} centered>
                <ModalHeader className="bg-light p-3" toggle={toggleList}>Aggiungi Cliente</ModalHeader>
                <form className="tablelist-form" onSubmit={handleAddCliente}>
                    <ModalBody>
                    ...
                    <Col lg={2}>
                        ...
                        <Col lg={1}>
                            <div className="form-check form-check-inline mt-4">
                                <Input className="form-news-input" type="checkbox" id="inlineCheckbox8" checked={newNews} onChange={(e) => setNewNews(e.target.checked)} />
                                <UncontrolledTooltip placement='top' target="cheese-icon-new">News</UncontrolledTooltip>
                                <Label className="form-news-label" id="cheese-icon-new" htmlFor="inlineCheckbox6">News</Label>
                            </div>
                        </Col>
                        <Col lg={1}>
                            <div className="form-check form-check-inline mt-4">
                                <Input className="form-privacy-input" type="checkbox" id="inlineCheckbox7" checked={newPrivacy} onChange={(e) => setNewPrivacy(e.target.checked)} />
                                <UncontrolledTooltip placement='top' target="cheese-icon-new">Privacy</UncontrolledTooltip>
                                <Label className="form-privacy-label" id="cheese-icon-new" htmlFor="inlineCheckbox6">Privacy</Label>
                            </div>
                        </Col>
                    ...
                    <ModalFooter>
                        <div className="hstack gap-2 justify-content-end">
                            ...
                            <button type="submit" className="btn btn-success" id="add-btn">Aggiungi Cliente</button>
                        </div>
                    </ModalFooter>
                </form>
            </Modal>
